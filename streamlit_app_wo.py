...
def first():
    ...
    st.session_state.question = (completion_tmp.choices[0].message.content)
...
def click1(text):
    choice = {"role": "user", "content": text}  # 質問候補文
    ...
    st.session_state.question = completion2.choices[0].message.content
    ...
    st.session_state.aizuchi = completion3.choices[0].message.content
...
if st.session_state.aizuchi:
    choices = [st.session_state.question.split("\n")[0][2:], st.session_state.question.split("\n")[1][2:], st.session_state.aizuchi]
else:
    choices = [st.session_state.question.split("\n")[i][2:] for i in range(3)]
with button_placeholder.container():
    st.button(choices[0], key='b1', on_click=lambda: click1(choices[0]))
    st.button(choices[1], key='b2', on_click=lambda: click1(choices[1]))
    st.button(choices[2], key='b3', on_click=lambda: click1(choices[2]))
